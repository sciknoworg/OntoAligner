...
5. Export Capability: The final matching results are saved in XML or JSON format and can be returned, ensuring compatibility with external tools and workflows.
...
Characteristics of the OntoAligner Pipeline:

1. It performs ontology alignment in one step.
2. Supports Lightweight matching, Retriever-based matching, LLM-based matching, and RAG (Retrieval-Augmented Generation) variants.
3. It follows a dataset-first approach: you load your alignment task and then choose the model to use for matching.
